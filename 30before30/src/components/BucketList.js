        ...
        <div className="bucketListScene">
          <div className="BucketListHeader">
            ...
            <div className="headerUtilities">
              <h5>Sort</h5>
              {/* <SortComponent /> */}
              <h5 onClick={this.toggleSearch} id="SearchBar">
                Search
              </h5>
            </div>
            <div className="bucketListSearchBar">{this.renderSearch()}</div>
          </div>
          <div id="bucketListProgress">
            <p id="bucketListProgress">Progress: %0</p>
          </div>
          <div className="navTabs">
            <div id="activeTab" onClick={this.activeTab}>
              Active
            </div>
            <div id="achievedTab" onClick={this.achievedTab}>
              Achieved
            </div>
          </div>
          <div className="bucketListBody">{this.renderBucketList()}</div>
          <div className="buttonContainer">
            <Link to="/list-item" id="addItemButton">
              Add
            </Link>
          </div>
          <NavigationTabs />
